...
void AThirdProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AThirdProjectCharacter::OnResetVR);
}


void AThirdProjectCharacter::OnResetVR()
{
	// If ThirdProject is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in ThirdProject.Build.cs is not automatically propagated
